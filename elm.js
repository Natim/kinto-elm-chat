...
var _user$project$Utils$timeAgo = F2(
	function (time, now) {
...
var _user$project$Main$client = A2(
	_Kinto$elm_kinto$Kinto$client,
...
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {author: a, messages: b, prepareMessage: c, currentTime: d, error: e};
	});
var _user$project$Main$Message = F3(
	function (a, b, c) {
		return {author: a, message: b, last_modified: c};
	});
...
var _user$project$Main$recordResource = A3(_Kinto$elm_kinto$Kinto$recordResource, 'kintochat', '4815162342', _user$project$Main$modelDecoder);
...
var _user$project$Main$getData = A2(
	...
	_user$project$Main$InitialList,
	A2(
		...
		A2(_Kinto$elm_kinto$Kinto$getList, _user$project$Main$recordResource, _user$project$Main$client)));
...
var _user$project$Main$sendMessage = F2(
	function (author, message) {
		...
		return A2(
			...
			A3(_Kinto$elm_kinto$Kinto$create, _user$project$Main$recordResource, jsonMessage, _user$project$Main$client));
	});
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								...
								messages: _elm_lang$core$List$reverse(_p0._0._0)
							}),
			...
			default:
				if (_p0._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{error: _elm_lang$core$Maybe$Nothing, prepareMessage: ''}),
						_1: _user$project$Main$getData
					};
				} else {
					return {
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('app-card mdl-card mdl-shadow--2dp'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('mdl-textfield mdl-js-textfield mdl-textfield--floating-label'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$input,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$NewAuthorName),
												_1: {
													ctor: '::',
									...
									_1: {
										...
										_0: A2(
											_elm_lang$html$Html$label,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$for('messages'),
													_1: {ctor: '[]'}
												}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('My name is'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
														...
														},
														{
															...
															_1: {
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text(l.author),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$class('time-ago'),
																			_1: {ctor: '[]'}
																		},
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text(
																				A2(_user$project$Utils$timeAgo, l.last_modified, model.currentTime)),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html$text(l.message),
																				_1: {ctor: '[]'}
																			}),
																		_1: {ctor: '[]'}
																	}
										...
										},
										{
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Write someting nice…'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
